...
const Color lightgreenColor = Color.fromRGBO(148, 255, 225, 1);
const Color midgreenColor = Color.fromRGBO(68, 192, 157, 1);
const Color bgcolor = Color.fromRGBO(0, 10, 6, 1);
const Color referColor = Color.fromRGBO(64, 136, 116, 1);
...
const MaterialColor primarygreen =
  ...
  300: Color(0xFF4D8B79),
  400: Color(0xFF26725D),
  500: Color(_primarygreenPrimaryValue),
  600: Color(0xFF00513A),
  700: Color(0xFF004832),
  800: Color(0xFF003E2A),
...
const MaterialColor primarygreenAccent =
  ...
  700: Color(0xFF00E677),
});
const int _primarygreenAccentValue = 0xFF34FF9D;
